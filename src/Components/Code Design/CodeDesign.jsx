...
const CodeDesign = () => {
  return (
    <Box className="mainHeight" position={"relative"} maxW={"75rem"} margin={"auto"} py={"3rem"} px={"0.5rem"} mt={"5rem"}>
      <Box mt={"2rem"} mb={"2rem"}>
        <Divider bg="gray.700" />
      </Box>
      <Box background={"#080A0B"} width={{ base: "100%", md: "85%" }} minH={"30rem"} borderRadius={"1rem"}>
        <code>
